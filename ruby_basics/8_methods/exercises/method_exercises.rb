...
def common_sports (current_sports, favorite_sports)
   ...
   # current_sports_uniq = current_sports.uniq
   # favorite_sports_uniq = favorite_sports.uniq
   # common_in_both = []
   # current_sports_uniq. each do |current_sport|
   #     favorite_sports_uniq.each do |favorite_sport|
   #         if favorite_sport == current_sport
   #             common_in_both.push (current_sport)
   #         end
   #     end
   # end
   # common_in_both
